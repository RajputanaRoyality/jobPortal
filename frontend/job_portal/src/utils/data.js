...
export const jobSeekerFeatures = [
    ...
    },
    {
        ...
        description:
            "Chat with mentors and industry experts to improve your skills and job readiness.",
    },
    {
        icon: Award,
        title: "Skill Assessment",
        description:
        "Showcase your abilities with verified skill tests and earn badges that employers find attracted to."
    }
];
