...
const DashboardLayout = ({ activeMenu, children }) => {
    ...
    const [profileDropdownOpen, setProfileDropDownOpen] = useState(activeMenu || "dashboard");
    ...
    return (
        <div className="flex h-screen bg-gray-50">
            {/* Sidebar */}
            <div
                className={`fixed inset-y-0 left-0 z-50 transition-transform duration-300 transform ${isMobile ? (sidebarOpen ? "translate-x-0" : "-translate-x-full") : "translate-x-0"
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500 hidden sm:block">
                                Here's what's happening with your job hunt today.
                            </p>
                        </div>
                    </div>
