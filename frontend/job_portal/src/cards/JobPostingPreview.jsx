...
const JobPostingPreview = ({ FormData, setIsPreview }) => {
    const { user } = useAuth();
    const currencies = [{ value: "rs.", label: "₹" }];
        ...
        <div className="max-w-4xl mx-auto">
            <div className="mb-8 backdrop-blur-sm bg-white/80 border border-white/20 shadow-xl rounded-2xl px-6 pt-6">
                <div className="flex items-center space-x-4">
                    <div className="text-lg md:text-xl font-bold bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent">
                        <h2 className="">
                            Job Preview
                        </h2>
                    </div>
                ...
                <div className="">
                        ...
                        <div className="relative z-10">
                            <div className="flex items-start justify-between mb-0">
                                ...
                                {user?.companyLogo ? (
                                    ...
                                    <div className="w-20 bg-gray-50 border-2 border-gray-200 rounded-2xl flex items-center justify-center">
                    ...
                    <div className="px-0 pb-8 space-y-8">
                        {/*Salary section*/}
                        <div className="relative overflow-hidden bg-gradient-to-r from-emerald-5 to-teal-50 border border-emerald-100 p-6 rounded-2xl">
                            <div className="absolute top-0 right-0 w-32 bg-gradient-to-br from-emerald-400/10 to-teal-400/10 rounded-full -translate-y-16 translate-x-16">
                                <div className="relative z-10">
