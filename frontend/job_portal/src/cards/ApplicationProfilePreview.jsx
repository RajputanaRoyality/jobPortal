...
const ApplicationProfilePreview = ({
    ...
    return <div className="fixed inset-0 bg-[rgba(0,0,0,0.2)] bg-opacity-50 flex items-center justify-center">
            ...
            <div className="p-6">
                <div className="text-center mb-6">
                    {selectedApplicant.applicant.avatar ? (
                        <img src={selectedApplicant.applicant.avatar}
                ...
                <div className="soace-y-4">
                    ...
                    <button
                        onClick={() => 
                            handleDownlaodResume(selectedApplicant.applicant.resume)
                        }
                        className="w-full inline-flex items-center justify-center gap-2 px-4 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors"
                    >
