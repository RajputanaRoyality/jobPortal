...
const Hero = () => {
    ...
    const stats = [
        ...
        { icon: Building2, label: "Companies", value: "56k+" },
        { icon: TrendingUp, label: "Jobs Posted", value: "150k+" },
    ]

    return (
        <section className="pt-24 pb-16 bg-white flex items-center"
            style={{
        ...
        >
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center" >
                    ...
                    <motion.h1
                        ...
                        className="text-4xl md:text-5xl lg:text-6xl font-bold text-zinc-800 mb-6 leading-tight pt-10"
                    >
                        Find Your Dream Job or
                        <span className="block bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent mt-21">
                            Perfect Hire
                        </span>
                    </motion.h1>
                    ...
                    <motion.p
                        ...
                        className="text-xl md:text-xl text-zinc-800 mb-12 max-w-2xl mx-auto leading-relaxed">
                        Connect talented profesionals.
                        Your next move to build your career.
                    </motion.p>
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute top-1/2 left1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-blue-50 to-purple-50 rounded-full blur-3xl opacity-20" />
            </div>
        </section>
    )
}
