...
const JobSeekerDashboard = () => {
  ...
  //Fetch jobs when filtered change (debounced)
  useEffect(() => {
    const timeoutId = setTimeout(() => {
      const apiFilters = {
        ...
        type: filters.type,
        experience: filters.exprerience,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 lg:py-8">
          ...
          <div className="flex gap-6 lg:gap-8">
            ...
            <div className="flex-1 min-w-0">
              {/*Results Header*/}
              <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-6 lg:mb-8 gap-8">
                <div>
                ...
                <div className="flex items-center justify-between lg:justify-end gap-4">
                  ...
                  <button
                    ...
                    className="lg:hidden flex items-center gap-2 bg-white px-4 py-2 rounded-xl border border-r-gray-200 font-medium text-gray-700 hover:bg-gray-50 transition-colors"
                  >
                  ...
                  <div className="flex items-center gap-3 lg:gap-4">
                    <div className="flex items-center border border-r-gray-200 rounded-l-xl p-1 bg-white">
                      <button
              ...
              {/*job grid*/}
              {jobs.length === 0 ? (
                <div className="text-center py-6 lg-py-20 bg-white/60 backdrop-blur-xl rounded-2xl border border-white/20">
                  ...
                  <button
                    ...
                    className="bg-blue-600 text-white px-6 rounded-xl font-semibold hover:bg-blue-700 transition-colors"
                  >
                    Clear All Filters
                  </button>
                </div>
