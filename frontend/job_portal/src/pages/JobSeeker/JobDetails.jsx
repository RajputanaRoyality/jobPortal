          ...
          <>
            <div className="bg-white p-6 rounded-lg">
              ...
              <div className="space-x-4">
                ...
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-full">
                  <div className="text-gray-700 leading-relaxed whitespace-pre-wrap">{jobDetails.requirements}
                  </div>
                </div>
              </div>
            </div>
