          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl shadow-black/5 border border-white/20 p-6 mb-8">
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="flex-1 relative">
                ...
                <input type="text"
                  ...
                  className='block w-full pl-10 pr-4 py-2 text-sm border border-gray-200 rounded-lg focus-within:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-0 transition-all duration-300 bg-gray-50/50 placeholder-gray-400'
                />
              </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-white/20 overflow-hidden">
              {filteredAndSortedJobs.length === 0 && !isLoading ? (
                ...
                <div className="w-[75vh] md:w-full overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className='bg-gradient-to-r from-gray-50 to-gray-100/50'>
                      <tr>
                        <th
                          className='px-6 py-4 text-xs font-semibold text-gray-600 uppercase tracking-wider cursor-pointer hover:bg-gray-100/60 transition-all duration-200 min-w-[200px] sm:min-w-0'
                        ...
                        <th className='px-6 py-4 text-xs font-semibold text-gray-600 uppercase tracking-wider cursor-pointer hover:bg-gray-100/60 transition-all duration-200 min-w-[200px] sm:min-w-0'
                        ...
                        : paginatedJobs.map((job) => (
                          ...
                          >
                            ...
                            <td className='px-6 py-5 whitespace-nowrap min-w-[120px] sm:min-w-0'>
                              <span className={`inline-flex px-3 py-1.5 text-xs font-semibold rounded-full ${job.status === "Active"
                            ...
                            <td className="px-6 py-5 whitespace-nowrap min-w-[120px] sm:min-w-0">
                              <div className="flex space-x-2">
                                <button className='text-blue-600 hover:text-blue-800 font-semibold transition-colors duration-200 hover:bg-blue-50 px-2 py-1 rounded-lg'
                                  onClick={() => navigate("/post-job", {
                                    state: { jobId: job.id },
                                  })}>
                                ...
                                {job.status === "Active" ? (
                                  ...
                                  <button onClick={() => handleStatusChange(job.id)}
