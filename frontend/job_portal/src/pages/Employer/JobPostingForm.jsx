...
import TextareaField from '../../input/TextfieldArea.jsx'
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200 || response.status === 201) {
        ...
        navigate("/employer-dashboard"); // <- put your actual route here
        return;
      }
          ...
          <div className="bg-white shadow-xl rounded-2xl p-6">
            ...
            <div className="space-y-6">
              ...
              <TextareaField
                ...
                helperText="Include required skills, experience level, education and any preferred qualification"
                required
              />
